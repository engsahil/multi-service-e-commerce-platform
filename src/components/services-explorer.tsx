...
export function ServicesExplorer({ services }: { services: Service[] }) {
  ...
  return <>
    <section className="page-hero"><div className="shell page-hero-grid"><div><p className="eyebrow">Servixa</p><h1 className="display">{t("allServices")}</h1></div><p className="lead">{t("allServicesSub")}</p></div></section>
